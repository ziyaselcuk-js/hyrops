...
.addField('Kullanım', `h!rol :emoji: Rol Adı
h!rol :emoji: everyone
h!rol emojiadi kaldır
h!rol :emoji: kaldır`)
.addField('Örnekler', `h!rol :superemoji: Süper İnsanlar
h!rol superemoji everyone
h!rol :superemoji: kaldır`)
.addField('Kısaltmalar', `h!rol`)
