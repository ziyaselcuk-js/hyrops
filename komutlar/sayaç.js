...
let sayaç = db.fetch(`ottoman.sayaç_${message.guild.id}`)
...
db.delete(`ottoman.sayaç_${message.guild.id}`)
db.delete(`ottoman.sayaçk_${message.guild.id}`)
...
db.set(`ottoman.sayaç_${message.guild.id}`, sayı)
db.set(`ottoman.sayaçk_${message.guild.id}`, kanal.id)
