...
var bos = "Aranıyor..."
 ...
 if(!store)return message.channel.send("Hangi oyunu aratmak istersin. **Kullanımı:** `h!playstore oyun ismi`")
 if(!link)return message.channel.send("⚠️ Oyun bulunamadı.")
