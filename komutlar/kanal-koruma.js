...
exports.run = async (client, message, args) => {
 let prefix = await require('quick.db').fetch(`prefix_${message.guild.id}`) || 'h!'
 ...
 .setDescription(
 "⚠️ **Hatalı kullanım! örnek: h!kanal-koruma aç/kapat**"
 );
 ...
 const embed = new Discord.MessageEmbed()
 .setColor("BLACK")
 .setTitle("HyropsBOT |Kanal Koruma sistemi!")
